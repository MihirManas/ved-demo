      ...
      <div className="bg-white dark:bg-white/[0.02] backdrop-blur-2xl border border-gray-100 dark:border-white/[0.05] rounded-3xl p-7 shadow-xl dark:shadow-2xl relative overflow-hidden">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className={`relative border-2 border-dashed ${image ? 'border-[#E6C875]/50 bg-[#E6C875]/5' : 'border-gray-300 dark:border-neutral-800 bg-white dark:bg-[#1F3145]/50'} rounded-xl p-4 flex flex-col items-center justify-center transition-all hover:border-gray-400 dark:hover:border-[#E6C875]/50 group overflow-hidden min-h-[160px]`}>
                  {image ? (
                    <div className="relative w-full h-32 mb-4">
                      ...
                      <button 
                        type="button"
                        onClick={() => setImage("")}
                        className="absolute top-2 right-2 bg-white/90 dark:bg-[#1F3145]/70 hover:bg-red-50 dark:hover:bg-red-500/80 text-red-600 dark:text-white p-1.5 rounded-md transition-colors shadow-md"
                      >
                        <X className="w-4 h-4" />
                      </button>
                    </div>
                    ...
                    <UploadDropzone
                      ...
                      appearance={{
                        ...
                        button: "bg-[#E6C875] text-[#1F3145] font-bold mt-4"
                      }}
                    />
                  )}
                </div>
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-white dark:bg-[#1F3145]/50 border border-gray-300 dark:border-neutral-800 rounded-xl px-4 py-3 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-[#E6C875]/50 focus:border-transparent transition-all text-sm"
                    required
                  />
                </div>
                <div>
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full bg-white dark:bg-[#1F3145]/50 border border-gray-300 dark:border-neutral-800 rounded-xl px-4 py-3 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-[#E6C875]/50 focus:border-transparent transition-all resize-none text-sm"
                  required
                />
              </div>
            </div>
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 w-full md:w-auto px-10 py-3 bg-[#E6C875] hover:bg-[#d4b55e] text-[#1F3145] font-semibold rounded-xl transition-all shadow-[0_0_20px_rgba(230,200,117,0.2)] disabled:opacity-50"
          >
            {isSubmitting ? (
      ...
      <div className="bg-white dark:bg-white/[0.02] backdrop-blur-2xl border border-gray-100 dark:border-white/[0.05] rounded-3xl p-7 shadow-xl dark:shadow-2xl relative overflow-hidden">
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
            {courses.map((course) => (
              <div key={course.id} className="bg-gray-50 dark:bg-[#1F3145]/40 border border-gray-200 dark:border-neutral-800 rounded-2xl overflow-hidden relative group hover:border-gray-300 dark:hover:border-neutral-700 transition-colors flex flex-col h-full shadow-sm">
                {/* Actions */}
