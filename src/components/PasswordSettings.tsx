      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          ...
          <input
            ...
            className="w-full bg-gray-50 dark:bg-[#1F3145]/50 border border-gray-200 dark:border-white/10 rounded-xl px-4 py-3 text-gray-900 dark:text-white focus:outline-none focus:ring-1 focus:ring-[#E6C875]"
          />
        </div>
        <div>
        ...
        <button
          ...
          className="w-full bg-[#E6C875] hover:bg-[#d4b55e] text-[#1F3145] font-bold py-3 rounded-xl transition-all disabled:opacity-50 mt-4 uppercase tracking-widest text-sm"
        >
