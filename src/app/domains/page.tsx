...
export default function Domains() {
  ...
  const filteredCourses = coursesList.filter(c => c.category === activeCategory);
        ...
        <div className="flex flex-col lg:flex-row gap-16 relative">
          ...
          <div className="lg:w-1/4 flex-shrink-0">
            <div className="sticky top-32">
              ...
              <nav className="flex flex-col space-y-2 relative">
                {/* Decorative dots mimicking the screenshot background */}
          ...
          <div className="lg:w-3/4">
            <ScrollReveal key={activeCategory}>
              <div className="mb-10">
                <h2 className="text-3xl md:text-4xl font-medium tracking-tight text-gray-900 dark:text-white mb-2 flex items-center">
                  <span className="text-[#E6C875] mr-4">{categories.indexOf(activeCategory) + 1}.</span> 
                  {activeCategory}
                </h2>
                <div className="w-24 h-[1px] bg-[#E6C875]/50 mt-6"></div>
              </div>
