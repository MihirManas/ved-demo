      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <ScrollReveal>
          <div className="text-center bg-white dark:bg-white/[0.02] border border-gray-200 dark:border-white/10 rounded-[4rem] p-24 backdrop-blur-3xl shadow-2xl dark:shadow-[0_0_100px_rgba(0,0,0,0.5)]">
            ...
            <Link
              href="/apply"
              className="inline-block bg-[#1F3145] dark:bg-white text-white dark:text-[#1F3145] px-16 py-6 rounded-full font-bold uppercase tracking-widest text-xl hover:bg-[#E6C875] dark:hover:bg-[#E6C875] hover:scale-105 transition-all duration-500 ease-out shadow-xl dark:shadow-[0_0_40px_rgba(255,255,255,0.1)]"
            >
              Apply For Domain
            </Link>
          </div>
