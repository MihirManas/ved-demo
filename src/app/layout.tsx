...
export const viewport: Viewport = {
  ...
  themeColor: [
    ...
    { media: "(prefers-color-scheme: dark)", color: "#1F3145" }
  ]
};
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      ...
      <body className={inter.className}>
        ...
        >
          <ContentProtection>
            <div className="relative min-h-screen bg-[#F8F9FA] dark:bg-[#1F3145] text-gray-900 dark:text-white overflow-x-clip transition-colors duration-1000 ease-in-out">
              ...
              <div className="fixed inset-0 pointer-events-none transition-opacity duration-1000 ease-in-out z-0 bg-gradient-to-tr from-[#E6C875]/5 via-[#1F3145] to-[#1F3145]/80 dark:opacity-100 opacity-0" />
