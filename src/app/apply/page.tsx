...
const inputBase = "w-full bg-white/50 dark:bg-white/[0.03] border border-gray-200 dark:border-white/10 text-gray-900 dark:text-white rounded-[1.5rem] px-6 py-5 focus:outline-none focus:border-[#E6C875] focus:bg-white dark:focus:bg-[#1F3145]/80 transition-all duration-500 font-light placeholder:text-gray-400 dark:placeholder:text-white/30 hover:border-[#E6C875]/50 hover:bg-white dark:hover:bg-white/[0.05] shadow-inner dark:shadow-[inset_0_2px_20px_rgba(255,255,255,0.02)]";
const selectBase = "w-full bg-white/50 dark:bg-white/[0.03] border border-gray-200 dark:border-white/10 text-gray-900 dark:text-white rounded-[1.5rem] px-6 py-5 focus:outline-none focus:border-[#E6C875] focus:bg-white dark:focus:bg-[#1F3145]/80 transition-all duration-500 appearance-none font-light hover:border-[#E6C875]/50 hover:bg-white dark:hover:bg-white/[0.05] shadow-inner dark:shadow-[inset_0_2px_20px_rgba(255,255,255,0.02)] cursor-pointer";
      ...
      {stepLabels.map((label, i) => (
        <div key={i} className="flex flex-col items-center flex-1 relative z-10">
          <div className={`w-12 h-12 rounded-full flex items-center justify-center text-sm font-bold transition-all duration-700 ease-out border backdrop-blur-md ${
            i < currentStep ? 'bg-[#E6C875] text-[#1F3145] border-[#E6C875] scale-90' :
            i === currentStep ? 'bg-[#E6C875] text-[#1F3145] border-[#E6C875] scale-110 shadow-[0_0_30px_rgba(230,200,117,0.5)]' :
        ...
        {!isSuccess ? (
          <>
            ...
            <ScrollReveal delay={100}>
              <div className="bg-white/80 dark:bg-[#1F3145]/40 border border-gray-200 dark:border-white/[0.08] rounded-[3rem] sm:rounded-[4rem] p-8 sm:p-14 md:p-20 backdrop-blur-3xl shadow-2xl dark:shadow-[0_0_80px_rgba(0,0,0,0.8)] relative overflow-hidden">
                            ...
                            <button
                              ...
                              className={`px-6 py-4 rounded-[1.5rem] text-sm font-bold tracking-wider uppercase border transition-all duration-500 ease-out ${
                                formData.languages.includes(lang as never)
                                  ? 'bg-[#E6C875] border-[#E6C875] text-[#1F3145] shadow-[0_0_20px_rgba(230,200,117,0.3)] scale-105'
                      ...
                      <div className="space-y-10">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                          {programTiers.map((tier, idx) => (
                            ...
                            >
                              {idx === 2 && (
                                <div className="absolute top-0 right-0 bg-[#E6C875] text-[#1F3145] text-[9px] uppercase tracking-[0.2em] font-bold px-4 py-1.5 rounded-bl-xl shadow-lg">
                                  Highest ROI
                                </div>
                              )}
                              <div>
                ...
                <div className="flex justify-between items-center mt-16 pt-8 border-t border-gray-200 dark:border-white/10 relative z-20">
                  ...
                  {currentStep < TOTAL_STEPS - 1 ? (
                    <button
                      type="button"
                      onClick={handleNext}
                      className="bg-[#1F3145] dark:bg-white text-white dark:text-[#1F3145] font-bold uppercase tracking-widest text-sm rounded-full px-10 py-5 flex items-center gap-3 hover:bg-[#E6C875] dark:hover:bg-[#E6C875] hover:scale-105 transition-all duration-500 shadow-xl dark:shadow-[0_0_30px_rgba(255,255,255,0.1)]"
                    >
                    ...
                    <button
                      ...
                      className="bg-[#E6C875] text-[#1F3145] font-bold uppercase tracking-widest text-sm rounded-full px-10 py-5 flex items-center gap-3 hover:scale-105 transition-all duration-500 shadow-[0_0_30px_rgba(230,200,117,0.4)] disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
                    >
                      {isSubmitting ? (
                        <>
          ...
          <ScrollReveal>
            <div className="bg-white/80 dark:bg-white/[0.02] border border-gray-200 dark:border-white/[0.05] rounded-[4rem] p-12 sm:p-20 backdrop-blur-3xl shadow-2xl dark:shadow-[0_0_80px_rgba(0,0,0,0.5)] text-center relative overflow-hidden">
              ...
              <div className="inline-flex items-center gap-4 px-8 py-4 rounded-full bg-[#1F3145]/[0.03] dark:bg-white/[0.03] border border-gray-200 dark:border-white/10 backdrop-blur-md">
