...
export const metadata: Metadata = {
  title: 'Success Stories - Ved Upskilling',
  description: 'Explore our Success Stories to enhance your knowledge and career in tech.',
};
    ...
    <main className="min-h-screen pt-40 pb-40">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <section className="prose prose-lg dark:prose-invert max-w-none">
          <article>
            <h2>Overview</h2>
            <p>Details about Success Stories will be available here.</p>
          </article>
        </section>
      </div>
    </main>
