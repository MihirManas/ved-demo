            ...
            <ScrollReveal delay={100}>
              <div>
                ...
                <div className="grid relative mb-12 items-start min-h-[160px] md:min-h-[180px] lg:min-h-[220px]">
                  <h1 className="col-start-1 row-start-1 w-full text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-medium text-gray-900 dark:text-white tracking-tighter leading-[1.05]">
                ...
                <div className="flex flex-col sm:flex-row gap-5">
                  <Link
                    ...
                    className="bg-[#1F3145] dark:bg-white text-white dark:text-[#1F3145] px-10 py-5 rounded-full font-bold uppercase tracking-widest text-sm flex items-center justify-center space-x-3 hover:bg-[#E6C875] dark:hover:bg-[#E6C875] hover:scale-105 transition-all duration-500 ease-out shadow-xl dark:shadow-[0_0_40px_rgba(255,255,255,0.1)]"
                  >
                ...
                >
                  ...
                  <div className="p-10 relative z-20 flex-grow flex flex-col justify-between">
                    <div>
                      ...
                      <h3 className="text-3xl font-medium tracking-tight text-gray-900 dark:text-white mb-4 group-hover:text-[#1F3145] dark:group-hover:text-white transition-colors duration-500">{course.title}</h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <ScrollReveal>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-y-12">
              ...
              <div className="text-center md:border-r border-gray-200 dark:border-white/10 px-4">
                <p className="text-4xl sm:text-5xl lg:text-6xl font-medium tracking-tighter text-[#E6C875]">60+</p>
              ...
              <div className="text-center px-4">
                <p className="text-4xl sm:text-5xl lg:text-6xl font-medium tracking-tighter text-[#E6C875]">4.9+</p>
                  ...
                  {[...Array(2)].map((_, i) => (
                    <div key={i} className="flex justify-around items-center gap-10 md:gap-20 px-5 md:px-10">
                      {[
                        ...
                        <div key={`${i}-${body.name}`} className="relative group flex items-center justify-center w-32 h-16 md:w-48 md:h-24 bg-white dark:bg-[#f0f0f0] p-3 rounded-2xl shadow-sm hover:shadow-lg transition-all duration-300 cursor-pointer border border-gray-100 hover:-translate-y-1">
                          <img
                            src={body.src}
                            alt={body.name}
              ...
              <ScrollReveal key={idx} delay={(idx % 2 + 1) * 100}>
                <div className="bg-white dark:bg-white/[0.02] border border-gray-200 dark:border-white/[0.05] p-8 md:p-12 rounded-3xl md:rounded-[3rem] shadow-xl dark:shadow-none hover:shadow-2xl dark:hover:bg-white/[0.03] transition-all backdrop-blur-xl h-full flex flex-col justify-between">
                  ...
                  <div className="flex items-center space-x-6 border-t border-gray-200 dark:border-white/10 pt-8 mt-auto">
                    <div className={`w-16 h-16 bg-gradient-to-br ${review.bg} rounded-full border border-[#1F3145]/10 dark:border-white/20 flex items-center justify-center overflow-hidden shadow-lg dark:shadow-[0_0_20px_rgba(230,200,117,0.2)]`}>
                      <span className="text-white dark:text-[#1F3145] font-bold text-xl tracking-widest">{review.initials}</span>
                    </div>
                    <div>
