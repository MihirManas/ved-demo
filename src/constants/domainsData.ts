export const domainsData: Record<string, any> = {
  ...
  "advanced-java": {
    ...
    syllabus: [
      "Week 1: Java Fundamentals Refresher|Revisiting Java basics: OOP principles, classes, and objects.|Advanced data structures: Collections Framework (List, Map, Set, Queue).|Generics in Java: Type safety and reusability.|Hands-on Practice: Create a library management system using the Collections Framework.",
      "Week 2: Exception Handling and Multithreading|Advanced exception handling: Custom exceptions and best practices.|Multithreading concepts: Thread lifecycle, synchronization, and inter-thread communication.|Thread pools and Executors framework.|Hands-on Practice: Develop a multithreaded file downloader application.",
      "Week 3: File I/O and Java NIO|Advanced file handling using File I/O classes.|Working with Java NIO: Channels, buffers, and file locks.|Serialization and deserialization of objects.|Hands-on Practice: Build a program to handle large file processing with NIO.",
      "Week 4: Networking in Java|Networking basics: Sockets, HTTP, and TCP/IP.|Developing client-server applications.|Introduction to RESTful services in Java.|Hands-on Practice: Create a chat application using sockets.",
      "Week 5: Database Connectivity with JDBC|JDBC fundamentals: Establishing a connection, executing queries, and handling results.|Advanced JDBC: Callable statements, batch processing, and transaction management.|Integration with MySQL/PostgreSQL databases.|Hands-on Practice: Build a CRUD application with database interaction.",
      "Week 6: Servlets and JSP|Introduction to Servlets: Lifecycle, request, and response handling.|JSP fundamentals: Tags, directives, and implicit objects.|Session management: Cookies, session tracking, and URL rewriting.|Hands-on Practice: Develop a dynamic web application using Servlets and JSP.",
      "Week 7: Spring Framework Basics|Overview of Spring: Architecture and modules.|Dependency Injection (DI) and Inversion of Control (IoC).|Spring MVC: Creating web applications with controllers and views.|Hands-on Practice: Build a simple web application using Spring MVC.",
      "Week 8: Final Project and Advanced Topics|Final Project: Develop a complete web application (e.g., e-commerce, employee management system).|Advanced topics: Microservices with Spring Boot, Hibernate ORM, and REST APIs.|Introduction to Java 11+ features: Stream API, lambda expressions, and functional programming.|Presentation and feedback session."
    ]
  },
  "fullstack": {
    id: "fullstack",
    ...
    syllabus: [
      "Week 1: HTML and CSS Fundamentals|HTML basics: Tags, structure, and semantic elements.|CSS essentials: Selectors, properties, and responsive design with media queries.|Advanced CSS: Flexbox, Grid layout, and animations.|Hands-on Practice: Build a responsive personal portfolio webpage.",
      "Week 2: JavaScript Essentials|Core JavaScript: Variables, functions, and control structures.|DOM manipulation and event handling.|ES6+ features: Arrow functions, template literals, and destructuring.|Hands-on Practice: Create an interactive to-do list application.",
      "Week 3: Front-End Framework - React.js|Introduction to React: Components, JSX, and props.|State management and lifecycle methods.|React Router for single-page applications.|Hands-on Practice: Build a multi-page React application (e.g., blog or e-commerce site).",
      "Week 4: Advanced Front-End Concepts|APIs and AJAX: Fetching data using REST APIs.|Front-end tools: Webpack, Babel, and npm.|Debugging and performance optimization.|Hands-on Practice: Integrate a third-party API (e.g., weather or news) into a React application.",
      "Week 5: Introduction to Back-End Development|Node.js basics: Setting up a server and handling requests.|NPM and Express.js: Middleware, routing, and building REST APIs.|Hands-on Practice: Create a REST API for user authentication.",
      "Week 6: Database Integration|Introduction to databases: Relational (MySQL) and NoSQL (MongoDB).|CRUD operations and querying databases.|Using Mongoose for MongoDB and Sequelize for MySQL.|Hands-on Practice: Develop a backend system for managing user profiles.",
      "Week 7: Authentication and Deployment|User authentication: JWT and OAuth2.|Securing applications: Data validation and error handling.|Deployment: Hosting with platforms like Heroku, Vercel, or AWS.|Hands-on Practice: Implement user login and deploy a complete application.",
      "Week 8: Full Stack Project and Advanced Topics|Final Project: Develop a full-stack application (e.g., social media platform or task manager).|Advanced topics: Real-time communication with WebSockets, GraphQL basics.|Career preparation: Git version control, portfolio building, and interview preparation.|Presentation and feedback session."
    ]
  },
  "web-development": {
    id: "web-development",
  ...
  "blockchain": {
    ...
    syllabus: [
      "Week 1: Blockchain Basics|Introduction to blockchain technology: History, key concepts, and real-world applications.|How blockchain works: Blocks, transactions, and distributed ledger.|Types of blockchains: Public, private, and consortium blockchains.|Hands-on Practice: Create a simple blockchain in Python or JavaScript.",
      "Week 2: Cryptography and Security|Basics of cryptography: Hashing, digital signatures, and public/private keys.|Understanding consensus mechanisms: Proof of Work (PoW) and Proof of Stake (PoS).|Blockchain security: Immutability, anonymity, and decentralization.|Hands-on Practice: Implement SHA-256 hashing and a simple proof-of-work algorithm.",
      "Week 3: Smart Contracts|Introduction to smart contracts: Definition, use cases, and benefits.|Ethereum blockchain and Solidity programming language basics.|Writing and deploying smart contracts using Remix IDE.|Hands-on Practice: Develop a simple smart contract (e.g., a token or voting system).",
      "Week 4: Decentralized Applications (DApps)|Overview of DApps: Architecture, components, and benefits.|Interacting with smart contracts using web3.js or ethers.js.|Setting up the Ethereum development environment with Ganache and MetaMask.|Hands-on Practice: Build a basic DApp for managing tasks.",
      "Week 5: Blockchain Networks and Tokens|Setting up a private blockchain network using tools like Hyperledger or Ethereum.|Understanding tokens: ERC-20, ERC-721 standards, and token creation.|Hands-on Practice: Create and deploy a custom ERC-20 token.",
      "Week 6: Blockchain Scaling and Security|Blockchain scalability solutions: Layer-2 solutions (e.g., Polygon, Optimism).|Advanced consensus mechanisms: Delegated PoS, Practical Byzantine Fault Tolerance (PBFT).|Ensuring security: Smart contract vulnerabilities and best practices for securing DApps.|Hands-on Practice: Secure a smart contract against common vulnerabilities (e.g., reentrancy).",
      "Week 7: Real-World Applications and Integration|Applications of blockchain in industries: Finance, healthcare, supply chain, and gaming.|Integration with traditional systems: APIs and off-chain data.|Introduction to NFTs (Non-Fungible Tokens) and marketplaces.|Hands-on Practice: Build a basic NFT and mint it on a blockchain.",
      "Week 8: Final Project and Future Trends|Final Project: Develop a full-fledged blockchain application (e.g., tokenized asset platform, decentralized marketplace).|Exploring blockchain trends: DeFi (Decentralized Finance), DAO (Decentralized Autonomous Organizations).|Preparing for careers in blockchain: Tools, certifications, and portfolio building.|Presentation and feedback session."
    ]
  },
  ...
  "graphic-design": {
    ...
    syllabus: [
      "Week 1: Introduction to Graphic Design|Understanding design principles: Contrast, balance, alignment, proximity, and repetition.|Overview of design tools: Adobe Photoshop, Illustrator, Canva, and Figma.|Exploring design types: Branding, UI/UX, print, and digital design.|Hands-on Practice: Create a simple logo or flyer using Canva.",
      "Week 2: Typography and Color Theory|Basics of typography: Fonts, hierarchies, and readability.|Understanding color theory: Color wheel, harmonies, and emotional impact of colors.|Working with gradients, palettes, and contrast.|Hands-on Practice: Design a typographic poster with a balanced color palette.",
      "Week 3: Image Editing and Manipulation|Image composition and retouching techniques in Adobe Photoshop.|Working with layers, masks, and filters.|Advanced editing: Blending modes, photo manipulation, and creating composites.|Hands-on Practice: Create a surreal photo manipulation project.",
      "Week 4: Vector Graphics and Illustrations|Introduction to Adobe Illustrator and vector graphics.|Creating shapes, logos, and scalable illustrations.|Working with paths, strokes, and gradients.|Hands-on Practice: Design a custom logo or icon set.",
      "Week 5: Branding and Identity Design|Elements of brand identity: Logos, color schemes, and typography.|Designing business cards, letterheads, and promotional materials.|Creating style guides for consistent branding.|Hands-on Practice: Develop a mini-branding kit for a fictional company.",
      "Week 6: Layout Design and Digital Publishing|Introduction to Adobe InDesign for layouts and publications.|Designing brochures, magazines, and social media posts.|Working with grids, margins, and text wrapping.|Hands-on Practice: Create a multi-page brochure or digital portfolio.",
      "Week 7: UI/UX Basics and Web Graphics|Principles of user interface and user experience design.|Designing for screens: Resolutions, responsive design, and accessibility.|Creating wireframes and prototypes using Figma or Adobe XD.|Hands-on Practice: Design a basic web landing page prototype.",
      "Week 8: Final Project and Portfolio Building|Final Project: Design a complete branding package or a digital campaign.|Preparing a professional graphic design portfolio.|Tips for freelancing, networking, and landing design jobs.|Presentation and feedback session."
    ]
  },
  "ui-ux": {
    id: "ui-ux",
